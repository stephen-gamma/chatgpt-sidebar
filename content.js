function extractPageText() {
  try {
    ...
    const elementsToSkip = ['script', 'style', 'nav', 'header', 'footer', 'aside', 'noscript'];
    ...
    if (!extractedText || extractedText.length < 50) {
      const elements = document.body.querySelectorAll('p, h1, h2, h3, h4, h5, h6, div, span, article, section, main');
      const texts = [];
